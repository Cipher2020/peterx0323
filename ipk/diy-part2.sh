...
git clone https://github.com/syb999/openwrt-19.07.1/tree/master/package/network/services/msd_lite/luci-app-msd_lite
git clone https://github.com/syb999/openwrt-19.07.1/tree/master/package/network/services/msd_lite
